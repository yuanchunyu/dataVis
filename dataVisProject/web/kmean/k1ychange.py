...
f=open('k01yearspower.csv')
data=pd.read_csv(f,sep=',')
data.columns=['place','lon','lat','cooling','fuel','state','f','c','idc']
x=data[data['idc']==0]
#print x
x.to_csv('k01idc0.csv')
a=data[data['idc']==1]
#print x
a.to_csv('k01idc1.csv')
b=data[data['idc']==2]
#print x
b.to_csv('k01idc2.csv')
c=data[data['idc']==3]
#print x
c.to_csv('k01idc3.csv')
d=data[data['idc']==4]
#print x
d.to_csv('k01idc4.csv')
e=data[data['idc']==5]
#print x
e.to_csv('k01idc5.csv')

data.to_csv('k01yearspower.csv')
